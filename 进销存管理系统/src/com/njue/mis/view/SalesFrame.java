...
public class SalesFrame extends JInternalFrame
{
	...
	public JPanel importgoods()
	{
	    ...
	    ID_saleslable = new JLabel("销售票号:");
		ID_salestextField = new JTextField(10);
		ID_privoderLabel = new JLabel("客户编号:");
		...
		salesButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					JOptionPane.showMessageDialog(null,"该客户编号不存在，不符合完整性约束","警告",JOptionPane.WARNING_MESSAGE);
					return;
				}
