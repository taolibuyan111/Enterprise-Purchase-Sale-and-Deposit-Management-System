...
public class OutportFrame extends JInternalFrame
{
	...
	private void setEnableTrue()
	{
		...
		ID_outporttextField.setEnabled(true);
	...
	{
		PortOutServicesHandle handler=CommonFactory.getPortOutServices();
		Vector<PortOut> goodsVector=handler.getAllPortOut();
		
		private String[] columnNames =
		{
				"退货票号", "商品编号", "商品名称", "原始价格","数量","退货价格",
                "供应商编号","供应商名","退货时间","操作员"
		};
		...
		{
			PortOut goods=goodsVector.get(row);
